                  ...
                  {gameOver && (
                    <div className="absolute inset-0 bg-black/70 flex items-center justify-center rounded-lg">
                      <div className="text-center space-y-4">
                        <h3 className="text-white text-3xl font-bold">Snake Adventure Complete! 🐍</h3>
                        <div className="space-y-2">
                          <p className="text-[#FBFAF9] text-xl">Final Score: {score.toLocaleString()}</p>
                          <p className="text-[#A0055D] text-lg">MONAD Tokens: {Math.floor(score / 10)}</p>
                          <p className="text-yellow-400 text-lg">Snake Length: {snake.length}</p>
                          <p className="text-purple-400 text-lg">Level Reached: {level}</p>
                          <p className="text-green-400 text-lg">Max Combo: {maxCombo} 🔥</p>
                          {score > highScore && (
